...
public class GameManagerNinjaKnife : MonoBehaviour {
	...
	public static int score
	{
		...
		{
			_score = value;
			if(GamePlayManagerNinjaKnife.instance != null)
			GamePlayManagerNinjaKnife.instance.UpdateLable ();
		}
	}
	static int _score;
	...
	public static int Apple
	{
		...
		set
		{
			...
			if (GeneralFunction.intance != null)
			{
				...
				if (GeneralFunction.intance.pauseAppleLbl != null)
					GeneralFunction.intance.pauseAppleLbl.text = GameManagerNinjaKnife.Apple + "";
			}
		}
	}
