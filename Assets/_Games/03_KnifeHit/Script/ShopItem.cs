...
public class ShopItem : MonoBehaviour {
	...
	[SerializeField] SelectAnimation selectAnimation;
	...
	public void OnClick()
	{
		...
		if (KnifeUnlock)
		{
			GameManagerNinjaKnife.SelectedKnifeIndex = index;
    ...
    private void Update()
    {
		if (selectAnimation.isSelect)
			shopRef.onShowPriceTag(KnifeUnlock, knifeImage.sprite);
	}
